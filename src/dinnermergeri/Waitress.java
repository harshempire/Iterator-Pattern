...
public class Waitress {
    ...
    // it has two loops one for pancakehousemenu and dinnermenu
    public void printMenu(int withNewConstructs) {
        // one  loop for pancakehousemenu
        ...
        // one loop for dinnermenu
        MenuItem[] lunchItems = ((DinnerMenu) dinerMenu).getMenuItems();
